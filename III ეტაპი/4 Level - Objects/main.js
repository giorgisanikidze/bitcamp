...
//   if(users[i].skills.length > skill){
//     skill = users[i].skills.length;
//     pers = i;

//   }
// }
// console.log("most skills have " + pers);
...
//   }
// }
// console.log(`logged users are ${logged} and user that has more thanequal to 50 point are ${points}`);
